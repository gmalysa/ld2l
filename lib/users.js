 ...
 * @param[in] linear The linearization constant (see seasons.js) which selects a table
 * @return The linearized/adjusted medal value
 */
function adjustMedal(medal, linear) {
	if (medalTable[linear][medal])
		return medalTable[linear][medal];
	return 0;
}
