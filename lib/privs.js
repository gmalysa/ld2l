...
const PRIVS_MODIFY_ACCOUNT = 1;	//!< Can modify others' account information
const PRIVS_MODIFY_SEASON = 2;	//!< Can change season settings
const PRIVS_JOIN_SEASON = 3;	//!< Vouched, can sign up
const PRIVS_VIEW_PRIVS = 4;		//!< Allowed to view player privs
const PRIVS_VOUCH = 5;			//!< Allowed to vouch other players
const PRIVS_POST_NEWS = 6;		//!< Allowed to post news
const PRIVS_INELIGIBLE = 7;		//!< In good standing but can't play
const PRIVS_BANNED = 8;			//!< Removed from league, can't play
const PRIVS_CREATE_LOBBY = 9;	//!< Can create a lobby using KBaaS
...
module.exports = {
	...
	INELIGIBLE : PRIVS_INELIGIBLE,
	BANNED : PRIVS_BANNED,
	CREATE_LOBBY : PRIVS_CREATE_LOBBY,
